...
REPLACEMENTS = [
    ...
    ['bksport:', 'http://bk.sport.owl#', 'bksport_'],
    ['dct:', 'dct_'],
    ['geo:', 'geo_'],
    ['georss:', 'georss_'],
    ['rdf:', 'rdf_'],
...
#
# input: sparql original
# output: sparql encoded
def encode( sparql ):
    ...
    return normalized
#
# input:sparql encoded
# output: sparql original
...
def extract_variables(query):
    ...
    # print (query_form_match.group(0))
    if query_form_match:
        letter_pattern = r'\?(\w)'
